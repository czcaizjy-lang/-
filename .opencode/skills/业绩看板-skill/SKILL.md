...
- **自达号总业绩趋势**（折线图）: 自达号总 GMV/支付/退款，标签含「自达号」后缀
...
| `window.__personDrillRows` / `__personDrillPrevDate` / `__personDrillClickedDate` | 人员下探缓存的原始数据 |
